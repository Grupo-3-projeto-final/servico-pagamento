namespace servico_pagamento.Core.Templates
{
    ...
    {
        public const string BOLETO_HTML = @"
            <!DOCTYPE html>
            <html>
                <body>
                    <div class=""container"">
                        ...
                        <div class=""boleto-details"">
                            <div>
                                <div class=""info"">
                                    ...
                                    <div>Ânima Educacao LTDA</div>
                                </div>
                                <div class=""info"">
                                    <div>CNPJ:</div>
                                    <div>88.185.554/0001-51</div>
                                </div>
                            </div>
                            <div>
                                <div class=""info"">
                        ...
                        <div class=""line""></div>
                        <div class=""boleto-details-pagador"">
                            <div>
                                <div class=""info-pagador"">
                                    <div>Pagador:</div>
                                    <div style=""margin-left: 140px;"">{2}</div>
                                </div>
                                <div class=""info-pagador"">
                                    <div>CPF:</div>
                                    <div style=""margin-left: 140px;"">{3}</div>
                                </div>
                            </div>
                        </div>
                        <div class=""line""></div>
        ...
        public const string STYLE_HTML_BOLETO = @"<style>
                        body {
